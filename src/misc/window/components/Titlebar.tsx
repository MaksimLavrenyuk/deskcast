import React, {
  useEffect, createRef, useState, useContext,
} from 'react';
    ...
    <div className="window-titlebar">
      ...
      <section
        className={classNames('window-titlebar-content', {
          centered: mode === 'centered-title',
        })}
      >
        {menusVisible ? '' : <div className="window-title">{title}</div>}
      </section>
      ...
      <WindowControls platform={windowContext.platform} tooltips />
    </div>
  );
}
